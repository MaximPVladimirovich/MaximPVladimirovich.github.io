...
return [
    ...
    'timestamp' => 1671554063,
    'checksum' => '6a41559647688d18948f3db5ab4f3cc7',
    'files' => [
        ...
        'user/themes' => [
            'themes/pinpress' => [
                'file' => 'user/themes/pinpress/blueprints.yaml',
                'modified' => 1665247262
            ]
        ]
    ],
    'data' => [
        'items' => [
            ...
            'themes.pinpress.dropdown' => [
                'type' => '_parent',
                'name' => 'themes.pinpress.dropdown',
                'form_field' => false
            ],
            'themes.pinpress.dropdown.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.pinpress.dropdown.enabled',
                'validation' => 'loose'
            ]
        ],
        'rules' => [
        ...
        'nested' => [
            ...
            'themes' => [
                'pinpress' => [
                    'dropdown' => [
                        'enabled' => 'themes.pinpress.dropdown.enabled'
                    ]
                ]
            ]
        ],
